...
class UI_Controller(QtWidgets.QMainWindow):
    ...
    def check(self):
        ...
        self.saveConfig()
        isVirtual = self.challenges["challenge_list"][ch_index]["knob_type"] == "virtual"
        quality, budget_utilizaiton = simulateResult(self.challenges["challenge_list"][ch_index]["cfg_location"], self.challenges["challenge_list"][ch_index]["budget"], self.challenges["challenge_list"][ch_index]["sub-metric"], isVirtual)
