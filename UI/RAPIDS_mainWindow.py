...
""
        ...
        self.gridLayout_2.addWidget(self.doneB, 7, 1, 1, 1)

        self.submetric2L = QLabel(self.setupBox)
        self.submetric2L.setObjectName(u"submetric2L")

        self.gridLayout_2.addWidget(self.submetric2L, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.budgetShortText, 2, 1, 1, 1)

        self.overalL = QLabel(self.setupBox)
        self.overalL.setObjectName(u"overalL")

        self.gridLayout_2.addWidget(self.overalL, 6, 1, 1, 1)

        self.knob2L = QLabel(self.setupBox)
        self.knob2L.setObjectName(u"knob2L")

        self.gridLayout_2.addWidget(self.knob2L, 0, 1, 1, 1)

        self.submetric1L = QLabel(self.setupBox)
        self.submetric1L.setObjectName(u"submetric1L")

        self.gridLayout_2.addWidget(self.submetric1L, 5, 0, 1, 1)

        self.budgetL = QLabel(self.setupBox)
        self.budgetL.setObjectName(u"budgetL")

        self.gridLayout_2.addWidget(self.budgetL, 2, 0, 1, 1)

        self.knob1L = QLabel(self.setupBox)
        self.knob1L.setObjectName(u"knob1L")

        self.gridLayout_2.addWidget(self.knob1L, 0, 0, 1, 1)

        self.qualityEstimateL = QLabel(self.setupBox)
        self.qualityEstimateL.setObjectName(u"qualityEstimateL")

        self.gridLayout_2.addWidget(self.qualityEstimateL, 4, 0, 1, 1)

        self.knob2 = QDial(self.setupBox)
        self.knob2.setObjectName(u"knob2")

        self.gridLayout_2.addWidget(self.knob2, 1, 1, 1, 1)

        self.knob1 = QDial(self.setupBox)
        self.knob1.setObjectName(u"knob1")

        self.gridLayout_2.addWidget(self.knob1, 1, 0, 1, 1)

        self.knob3 = QDial(self.setupBox)
        self.knob3.setObjectName(u"knob3")

        self.gridLayout_2.addWidget(self.knob3, 1, 2, 1, 1)

        self.knob3L = QLabel(self.setupBox)
        self.knob3L.setObjectName(u"knob3L")

        self.gridLayout_2.addWidget(self.knob3L, 0, 2, 1, 1)

        self.checkB = QPushButton(self.setupBox)
        self.checkB.setObjectName(u"checkB")

        self.gridLayout_2.addWidget(self.checkB, 2, 2, 1, 1)

        self.submetric3L = QLabel(self.setupBox)
        self.submetric3L.setObjectName(u"submetric3L")

        self.gridLayout_2.addWidget(self.submetric3L, 5, 2, 1, 1)
